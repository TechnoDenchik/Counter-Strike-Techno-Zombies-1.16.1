...
void CMenuNewGame::_Init( void )
{
	...
	CMenuPicButton *easy = AddButton( "Easy", 0, PC_EASY, easyCallback, QMF_NOTIFY );
	CMenuPicButton *norm = AddButton( "Medium", 0, PC_MEDIUM, normCallback, QMF_NOTIFY );
	CMenuPicButton *hard = AddButton( "Difficult", 0, PC_DIFFICULT, hardCallback, QMF_NOTIFY );
