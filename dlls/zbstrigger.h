...
class CFrictionModifier2: public CBaseEntity
{
public:
	virtual void Spawn();
...
class CAutoTrigger2: public CBaseDelay
{
public:
	virtual void Spawn();
...
class CTriggerRelay2: public CBaseDelay
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CMultiManager2: public CBaseToggle
{
public:
	virtual void Spawn();
...
class CRenderFxManager2: public CBaseEntity
{
public:
	virtual void Spawn();
	virtual void Use(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value);
...
class ZBSTrigger: public CBaseToggle
{
public:
	virtual void KeyValue(KeyValueData *pkvd);
	virtual int ObjectCaps() { return (CBaseToggle::ObjectCaps() & ~FCAP_ACROSS_TRANSITION); }
...
class CTriggerHurt2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CTriggerCDAudio2: public ZBSTrigger
{
public:
	virtual void Spawn();
	virtual void Touch(CBaseEntity *pOther);
...
class CTargetCDAudio2: public CPointEntity
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CTriggerMultiple2: public ZBSTrigger
{
public:
	virtual void Spawn();
};
...
class CTriggerOnce2: public CTriggerMultiple2
{
public:
	virtual void Spawn();
};
...
class CTriggerCounter2: public ZBSTrigger
{
public:
	virtual void Spawn();
};
...
class CTriggerVolume2: public CPointEntity
{
public:
	virtual void Spawn();
};
...
class CFireAndDie2: public CBaseDelay
{
public:
	virtual void Spawn();
	virtual void Precache();
...
class CChangeLevel2: public ZBSTrigger
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
public:
	...
	char m_szMapName2[ cchMapNameMost ];		// trigger_changelevel only:  next map
	char m_szLandmarkName2[ cchMapNameMost ];	// trigger_changelevel only:  landmark on next map
	int m_changeTarget2;
	float m_changeTargetDelay2;
};

class CLadder2: public ZBSTrigger
{
public:
	virtual void Spawn();
	virtual void Precache();
...
class CTriggerPush2: public ZBSTrigger
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CTriggerTeleport2: public ZBSTrigger
{
public:
	virtual void Spawn();
};

class CBuyZone2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CBombTarget2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CHostageRescue2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CEscapeZone2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CVIP_SafetyZone2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CTriggerSave2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CTriggerEndSection2: public ZBSTrigger
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CTriggerGravity2: public ZBSTrigger
{
public:
	virtual void Spawn();
...
class CTriggerChangeTarget2: public CBaseDelay
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CTriggerCamera2: public CBaseDelay
{
public:
	virtual void Spawn();
	virtual void KeyValue(KeyValueData *pkvd);
...
class CWeather2: public ZBSTrigger
{
public:
	virtual void Spawn();
};
