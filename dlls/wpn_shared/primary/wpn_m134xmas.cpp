...
void CM134xmas::PrimaryAttack(void)
{
	if (!FBitSet(m_pPlayer->pev->flags, FL_ONGROUND))
		M134xmasFire(0.065 + (0.75) * m_flAccuracy, 0.06155f, FALSE);
	else if (m_pPlayer->pev->velocity.Length2D() > 140)
		M134xmasFire(0.045 + (0.095) * m_flAccuracy, 0.06155f, FALSE);
	else
		M134xmasFire((0.04) * m_flAccuracy, 0.06155f, FALSE);
}
