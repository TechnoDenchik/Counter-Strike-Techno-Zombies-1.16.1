...
void CAK47Dragon::Spawn(void)
{
	...
	Precache();
	m_iId = WEAPON_AK47;
	SET_MODEL(ENT(pev), "models/w_akd.mdl");
...
{
	PRECACHE_MODEL("models/v_akd.mdl");
	PRECACHE_MODEL("models/p_akd.mdl");
	PRECACHE_MODEL("models/w_akd.mdl");

	PRECACHE_SOUND("weapons/ak47-1.wav");
	PRECACHE_SOUND("weapons/ak47-2.wav");
	PRECACHE_SOUND("weapons/clipout.wav");
	PRECACHE_SOUND("weapons/clipin.wav");
	PRECACHE_SOUND("weapons/boltpull.wav");
...
BOOL CAK47Dragon::Deploy(void)
{
	...
	m_iShotsFired = 0;
	iShellOn = 1;
	return DefaultDeploy("models/v_akd.mdl", "models/p_akd.mdl", AK47_DRAW, "ak47", UseDecrement() != FALSE);
}
...
void CAK47Dragon::AK47Fire(float flSpread, float flCycleTime, BOOL fUseAutoAim)
{
	m_bDelayFire = true;
	m_iShotsFired++;
	...
	{
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "weapons/ak47-1.wav", VOL_NORM, ATTN_NORM);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "weapons/ak47-1.wav", VOL_NORM, ATTN_NORM);
		break;
