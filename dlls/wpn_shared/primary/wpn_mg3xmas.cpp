...
void CMG3xmas::PrimaryAttack(void)
{
	if (!FBitSet(m_pPlayer->pev->flags, FL_ONGROUND))
		MG3xmasFire(0.045 + (0.5) * m_flAccuracy, 0.095f, FALSE);
	else if (m_pPlayer->pev->velocity.Length2D() > 140)
		MG3xmasFire(0.045 + (0.095) * m_flAccuracy, 0.095f, FALSE);
	else
		MG3xmasFire((0.03) * m_flAccuracy, 0.095f, FALSE);
}
...
void CMG3xmas::Reload(void)
{
	...
	if (DefaultReload( 400, M249_RELOAD, 4.8f))
	{
#ifndef CLIENT_DLL
...
void CMG3xmas::WeaponIdle(void)
{
	...
	m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 70.0f;
