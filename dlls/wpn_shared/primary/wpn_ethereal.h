...
#ifndef WPN_ETHEREAL_H
#define WPN_ETHEREAL_H
#ifdef _WIN32
#pragma once
#endif
...
class CEthereal : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	...
	const char* GetCSModelName() override { return "models/w_ethereal.mdl"; }
...
public:
	void ETHEREALFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);
