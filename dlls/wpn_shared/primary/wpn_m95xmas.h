...
public:
	...
	const char *GetCSModelName() override { return "models/w_m95xmas.mdl"; }

public:
	void M95xmasFire(float flSpread, duration_t flCycleTime, BOOL fUseAutoAim);
	float GetDamage() const;
	int m_iShell;

private:
	unsigned short m_usFireM95xmas;
};