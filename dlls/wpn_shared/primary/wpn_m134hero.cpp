...
#include "weapons/WeaponTemplate.hpp"
    ...
    {
    public:
        static constexpr const auto& DefaultReloadTime = 4.8f;
        static constexpr int ZoomFOV = 55;
        static constexpr const char* V_Model = "models/v_m134hero.mdl";
        static constexpr const char* P_Model = "models/p_m134hero.mdl";
        static constexpr const char* W_Model = "models/w_m134hero.mdl";
        static constexpr const char* EventFile = "events/m134hero.sc";
        static constexpr InventorySlotType ItemSlot = PRIMARY_WEAPON_SLOT;
        static constexpr const char* ClassName = "weapon_m134hero";
        ...
        static constexpr const auto& CycleTime = 0.06f;
    ...
    LINK_ENTITY_TO_CLASS(weapon_m134hero, CM134HeroI)
    ...
    void CM134HeroI::SpecialAttack()
    {
        ...
        case FIRE_OFF:
        {
            ...
            pev->fuser1 = (UTIL_WeaponTimeBase() + 2.0f) / 1.0f;
        ...
        case FIRE_CHARGE:
        {
            ...
            if (pev->fuser1 <= UTIL_WeaponTimeBase() / 1.0f)
            {
        ...
        case FIRE_WIDE:
            ...
            if (pev->dmgtime < gpGlobals->time)
            {
                ...
                if (g_pGameRules->IsMultiplayer())
                {
                    ...
                    RadiusDamage(tr.vecEndPos, pev, m_pPlayer->pev, GetSecondaryAttackDamage() / 4, 128, CLASS_NONE, DMG_BULLET | DMG_ENERGYBEAM);
                }
                ...
                if (m_shakeTime < gpGlobals->time)
                {
                    ...
                    m_shakeTime = gpGlobals->time + 0.25f;
                }
            }
#endif
    ...
    void CM134HeroI::UpdateEffect(const Vector& startPoint, const Vector& endPoint, float timeBlend, bool bHit)
    {
        ...
        {
            if (m_fireMode == FIRE_WIDE)
                m_pBeam->SetColor((int)(64 + (25 * timeBlend)), (int)(72 + (30 * timeBlend)), (int)(30 + 25 * fabs(sin(gpGlobals->time* 10))));
            else
                m_pBeam->SetColor((int)(128 + (25 * timeBlend)), (int)(144 + (30 * timeBlend)), (int)(30 + 25 * fabs(sin(gpGlobals->time * 10))));
        }
        else
        {
            if (m_fireMode == FIRE_WIDE)
        ...
        m_pSprite->pev->frame += 8 * gpGlobals->frametime / 1.0f;
