...
void CTbarrel::PrimaryAttack(void)
{
	...
	m_flNextPrimaryAttack = UTIL_WeaponTimeBase() + 0.165f;
	m_flNextSecondaryAttack = UTIL_WeaponTimeBase() + 0.165f;
...
void CTbarrel::SecondaryAttack(void)
{
	...
	m_flNextPrimaryAttack = UTIL_WeaponTimeBase() + 0.48f;
	m_flNextSecondaryAttack = UTIL_WeaponTimeBase() + 0.48f;
	m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 2.25f;
...
void CTbarrel::Reload(void)
{
	...
	if (DefaultReload(MAX_CLIP, ANIM_RELOAD, 3.0f))
	{
#ifndef CLIENT_DLL
