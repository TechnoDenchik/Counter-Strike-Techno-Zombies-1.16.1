...
#ifndef WPN_VIOLINGUN_H
#define WPN_VIOLINGUN_H
#ifdef _WIN32
#pragma once
#endif
...
class CViolinGun : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	...
	const char* GetCSModelName() override { return "models/w_violingun.mdl"; }
...
public:
	void VIOLINGUNFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);
