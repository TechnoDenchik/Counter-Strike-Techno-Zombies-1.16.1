...
class CM134ex : public CBasePlayerWeapon
{
	enum m134ex_e
    {
        M134_IDLE1,
...
public:
	...
	const char *GetCSModelName() override { return "models/w_m134ex.mdl"; }
...
public:
	void M134exFire(float flSpread, duration_t flCycleTime, BOOL fUseAutoAim);
	float GetDamage() const;
	int m_iShell;
	int iShellOn;
	int m_iM134State = WPNSTATE_M134_IDLE;
	

private:
	unsigned short m_usFireM134ex;
};