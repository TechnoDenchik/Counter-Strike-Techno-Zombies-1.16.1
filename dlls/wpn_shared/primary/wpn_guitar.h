...
class CGuitar : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	...
	const char* GetCSModelName() override { return "models/w_guitar.mdl"; }
...
public:
	void GUITARFire(float flSpread, float flCycleTime, BOOL fUseAutoAim);

	int m_iShell;
	int iShellOn;

private:
	unsigned short m_usFireGuitar;
};
