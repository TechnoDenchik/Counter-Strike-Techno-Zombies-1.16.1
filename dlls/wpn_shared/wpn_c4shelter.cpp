...
LINK_ENTITY_TO_CLASS(weapon_c4shelter, CC4shelter)

void CC4shelter::Spawn(void)
{
...
int CC4shelter::GetItemInfo(ItemInfo *p)
{
...
void CC4shelter::Holster(int skiplocal)
{
...
void CC4shelter::PrimaryAttack(void)
{
...
void CC4shelter::WeaponIdle(void)
{
	if (m_bStartedArming == true)
	{
		m_bStartedArming = false;
...
void CC4shelter::KeyValue(KeyValueData *pkvd)
{
...
void CC4shelter::Use(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value)
{
	if (m_pPlayer)
		return;
