...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_booster.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_booster, CZombieBombBooster)

void CZombieBombBooster::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_booster");
	Precache();
...
void CZombieBombBooster::Precache(void)
{
...
int CZombieBombBooster::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombBooster::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombBooster::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombBooster::Holster(int skiplocal)
{
...
void CZombieBombBooster::PrimaryAttack(void)
{
...
void CZombieBombBooster::SetPlayerShieldAnim(void)
{
...
void CZombieBombBooster::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombBooster::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombBooster::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombBooster::WeaponIdle(void)
{
...
BOOL CZombieBombBooster::CanDeploy(void)
{
