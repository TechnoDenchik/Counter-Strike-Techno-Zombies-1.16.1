...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_china.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_china, CZombieBombChina)

void CZombieBombChina::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_china");
	Precache();
...
void CZombieBombChina::Precache(void)
{
...
int CZombieBombChina::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombChina::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombChina::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombChina::Holster(int skiplocal)
{
...
void CZombieBombChina::PrimaryAttack(void)
{
...
void CZombieBombChina::SetPlayerShieldAnim(void)
{
...
void CZombieBombChina::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombChina::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombChina::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombChina::WeaponIdle(void)
{
...
BOOL CZombieBombChina::CanDeploy(void)
{
