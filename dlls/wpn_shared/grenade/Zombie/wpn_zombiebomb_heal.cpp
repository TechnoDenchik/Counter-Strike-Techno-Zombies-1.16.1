...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_heal.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_heal, CZombieBombHeal)

void CZombieBombHeal::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_heal");
	Precache();
...
void CZombieBombHeal::Precache(void)
{
...
int CZombieBombHeal::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombHeal::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombHeal::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombHeal::Holster(int skiplocal)
{
...
void CZombieBombHeal::PrimaryAttack(void)
{
...
void CZombieBombHeal::SetPlayerShieldAnim(void)
{
...
void CZombieBombHeal::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombHeal::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombHeal::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombHeal::WeaponIdle(void)
{
...
BOOL CZombieBombHeal::CanDeploy(void)
{
