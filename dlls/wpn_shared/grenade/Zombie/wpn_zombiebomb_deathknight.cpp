...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_deathknight.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_deathknight, CZombieBombDeathKnight)

void CZombieBombDeathKnight::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_deathknight");
	Precache();
...
void CZombieBombDeathKnight::Precache(void)
{
...
int CZombieBombDeathKnight::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombDeathKnight::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombDeathKnight::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombDeathKnight::Holster(int skiplocal)
{
...
void CZombieBombDeathKnight::PrimaryAttack(void)
{
...
void CZombieBombDeathKnight::SetPlayerShieldAnim(void)
{
...
void CZombieBombDeathKnight::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombDeathKnight::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombDeathKnight::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombDeathKnight::WeaponIdle(void)
{
...
BOOL CZombieBombDeathKnight::CanDeploy(void)
{
