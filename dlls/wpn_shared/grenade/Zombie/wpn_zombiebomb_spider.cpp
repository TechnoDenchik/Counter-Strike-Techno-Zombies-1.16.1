...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_spider.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_spider, CZombieBombSpider)

void CZombieBombSpider::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_spider");
	Precache();
...
void CZombieBombSpider::Precache(void)
{
...
int CZombieBombSpider::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombSpider::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombSpider::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombSpider::Holster(int skiplocal)
{
...
void CZombieBombSpider::PrimaryAttack(void)
{
...
void CZombieBombSpider::SetPlayerShieldAnim(void)
{
...
void CZombieBombSpider::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombSpider::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombSpider::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombSpider::WeaponIdle(void)
{
...
BOOL CZombieBombSpider::CanDeploy(void)
{
