...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_banchee.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_banchee, CZombieBombBanchee)

void CZombieBombBanchee::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_banchee");
	Precache();
...
void CZombieBombBanchee::Precache(void)
{
...
int CZombieBombBanchee::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombBanchee::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombBanchee::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombBanchee::Holster(int skiplocal)
{
...
void CZombieBombBanchee::PrimaryAttack(void)
{
...
void CZombieBombBanchee::SetPlayerShieldAnim(void)
{
...
void CZombieBombBanchee::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombBanchee::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombBanchee::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombBanchee::WeaponIdle(void)
{
...
BOOL CZombieBombBanchee::CanDeploy(void)
{
