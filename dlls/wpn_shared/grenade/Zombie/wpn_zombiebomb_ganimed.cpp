...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_ganimed.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_ganimed, CZombieBombGanimed)

void CZombieBombGanimed::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_ganimed");
	Precache();
...
void CZombieBombGanimed::Precache(void)
{
...
int CZombieBombGanimed::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombGanimed::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombGanimed::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombGanimed::Holster(int skiplocal)
{
...
void CZombieBombGanimed::PrimaryAttack(void)
{
...
void CZombieBombGanimed::SetPlayerShieldAnim(void)
{
...
void CZombieBombGanimed::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombGanimed::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombGanimed::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombGanimed::WeaponIdle(void)
{
...
BOOL CZombieBombGanimed::CanDeploy(void)
{
