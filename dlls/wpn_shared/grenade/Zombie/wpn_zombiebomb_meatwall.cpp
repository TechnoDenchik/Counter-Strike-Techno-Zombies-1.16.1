...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_meatwall.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_meatwall, CZombieBombMeatWall)

void CZombieBombMeatWall::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_meatwall");
	Precache();
...
void CZombieBombMeatWall::Precache(void)
{
...
int CZombieBombMeatWall::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombMeatWall::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombMeatWall::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombMeatWall::Holster(int skiplocal)
{
...
void CZombieBombMeatWall::PrimaryAttack(void)
{
...
void CZombieBombMeatWall::SetPlayerShieldAnim(void)
{
...
void CZombieBombMeatWall::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombMeatWall::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombMeatWall::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombMeatWall::WeaponIdle(void)
{
...
BOOL CZombieBombMeatWall::CanDeploy(void)
{
