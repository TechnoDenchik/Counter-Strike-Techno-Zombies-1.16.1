...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_boomer.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_boomer, CZombieBombBoomer)

void CZombieBombBoomer::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_boomer");
	Precache();
...
void CZombieBombBoomer::Precache(void)
{
...
int CZombieBombBoomer::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombBoomer::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombBoomer::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombBoomer::Holster(int skiplocal)
{
...
void CZombieBombBoomer::PrimaryAttack(void)
{
...
void CZombieBombBoomer::SetPlayerShieldAnim(void)
{
...
void CZombieBombBoomer::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombBoomer::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombBoomer::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombBoomer::WeaponIdle(void)
{
...
BOOL CZombieBombBoomer::CanDeploy(void)
{
