...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_resident.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_resident, CZombieBombResident)

void CZombieBombResident::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_resident");
	Precache();
...
void CZombieBombResident::Precache(void)
{
...
int CZombieBombResident::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombResident::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombResident::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombResident::Holster(int skiplocal)
{
...
void CZombieBombResident::PrimaryAttack(void)
{
...
void CZombieBombResident::SetPlayerShieldAnim(void)
{
...
void CZombieBombResident::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombResident::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombResident::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombResident::WeaponIdle(void)
{
...
BOOL CZombieBombResident::CanDeploy(void)
{
