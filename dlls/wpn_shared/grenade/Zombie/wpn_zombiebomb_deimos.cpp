...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_deimos.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_deimos, CZombieBombDeimos)

void CZombieBombDeimos::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_deimos");
	Precache();
...
void CZombieBombDeimos::Precache(void)
{
...
int CZombieBombDeimos::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombDeimos::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombDeimos::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombDeimos::Holster(int skiplocal)
{
...
void CZombieBombDeimos::PrimaryAttack(void)
{
...
void CZombieBombDeimos::SetPlayerShieldAnim(void)
{
...
void CZombieBombDeimos::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombDeimos::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombDeimos::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombDeimos::WeaponIdle(void)
{
...
BOOL CZombieBombDeimos::CanDeploy(void)
{
