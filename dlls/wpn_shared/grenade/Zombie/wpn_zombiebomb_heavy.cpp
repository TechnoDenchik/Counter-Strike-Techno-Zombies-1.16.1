...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_heavy.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_heavy, CZombieBombHeavy)

void CZombieBombHeavy::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_heavy");
	Precache();
...
void CZombieBombHeavy::Precache(void)
{
...
int CZombieBombHeavy::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombHeavy::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombHeavy::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombHeavy::Holster(int skiplocal)
{
...
void CZombieBombHeavy::PrimaryAttack(void)
{
...
void CZombieBombHeavy::SetPlayerShieldAnim(void)
{
...
void CZombieBombHeavy::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombHeavy::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombHeavy::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombHeavy::WeaponIdle(void)
{
...
BOOL CZombieBombHeavy::CanDeploy(void)
{
