...
#include "player.h"
#include "weapons.h"
#include "wpn_zombiebomb_speed.h"

LINK_ENTITY_TO_CLASS(weapon_zombibomb_speed, CZombieBombSpeed)

void CZombieBombSpeed::Spawn(void)
{
	pev->classname = MAKE_STRING("weapon_zombibomb_speed");
	Precache();
...
void CZombieBombSpeed::Precache(void)
{
...
int CZombieBombSpeed::GetItemInfo(ItemInfo *p)
{
...
BOOL CZombieBombSpeed::Deploy(void)
{
	m_flReleaseThrow = 360;
	m_fMaxSpeed = 250;
	m_iWeaponState &= ~WPNSTATE_SHIELD_DRAWN;
...
BOOL CZombieBombSpeed::CanHolster(void)
{
	return CBasePlayerWeapon::CanHolster();
}

void CZombieBombSpeed::Holster(int skiplocal)
{
...
void CZombieBombSpeed::PrimaryAttack(void)
{
...
void CZombieBombSpeed::SetPlayerShieldAnim(void)
{
...
void CZombieBombSpeed::ResetPlayerShieldAnim(void)
{
	if (m_pPlayer->HasShield() == true)
	{
		if (m_iWeaponState & WPNSTATE_SHIELD_DRAWN)
...
bool CZombieBombSpeed::ShieldSecondaryFire(int up_anim, int down_anim)
{
...
void CZombieBombSpeed::SecondaryAttack(void)
{
	ShieldSecondaryFire(SHIELDGUN_DRAW, SHIELDGUN_DRAWN_IDLE);
}

void CZombieBombSpeed::WeaponIdle(void)
{
...
BOOL CZombieBombSpeed::CanDeploy(void)
{
