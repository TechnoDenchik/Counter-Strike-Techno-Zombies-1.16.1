...
void CEgon::CreateEffect( void )
{
	...
	m_pBeam = CBeam::BeamCreate("sprites/xbeam1.spr", 40 );
	...
	m_pNoise = CBeam::BeamCreate("sprites/xbeam1.spr", 55 );
	...
	m_pSprite = CSprite::SpriteCreate("sprites/XSpark1.spr", pev->origin, FALSE );
...
void CEgon::Reload(void)
{
	...
	if (DefaultReload(100, EGON_FIDGET1, 2.45))
	{
#ifndef CLIENT_DLL
