...
#include "gamemode/mods.h"
	...
	public:
		...
		void EXPORT AdditionalDamageThink()
		{
			...
			EMIT_SOUND_DYN(this->edict(), CHAN_WEAPON, "weapons/gungnir_charge_shoot_exp2.wav", VOL_NORM, ATTN_NORM, 0, PITCH_NORM);
...
class CHalogun : public LinkWeaponTemplate< CHalogun,TGeneralData,BuildTGetItemInfoFromCSW<WEAPON_AK47>::template type,TPrecacheEvent,TReloadDefault,TWeaponIdleDefault,TGetDamageDefault>
{
public:
enum
{
...
LINK_ENTITY_TO_CLASS(weapon_gungnir, CHalogun)

void CHalogun::Precache()
{
...
void CHalogun::Holster(int skiplocal)
{
	phs2 = -1;
	phs3 = -1;
	phs4 = -1;
...
void CHalogun::PrimaryAttack_FindTargets()
{
...
bool CHalogun::PrimaryAttack_CheckTargetAvailable(CBaseEntity* a2, Vector vecAngleDirection)
{
	const float flRadius = 320;
...
void CHalogun::PrimaryAttack_InstantDamage()
{
	if (phs9_10_11.empty())
	{
		ClearEffect();
