...
public:
	...
	int TakeDamage2(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage2, int bitsDamageType2) override;
	void Killed(entvars_t *pevAttacker, int iGib) override;
...
public:
	...
	int DeadTakeDamage2(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage2, int bitsDamageType2);
