...
void CZombieClass_Deimos::Precache()
{
...
CZombieClass_Deimos::CZombieClass_Deimos(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_Deimos::InitHUD() const
{
...
void CZombieClass_Deimos::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_Deimos::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_Deimos::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_Deimos::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_Deimos::DeathSound_Zombie()
{
...
void CZombieClass_Deimos::OnThink()
{
	Zombie_HealthRecoveryThink();
	return CZombieClass_Deimos::OnThink();
}

void CZombieClass_Deimos::Zombie_HealthRecoveryThink()
{
