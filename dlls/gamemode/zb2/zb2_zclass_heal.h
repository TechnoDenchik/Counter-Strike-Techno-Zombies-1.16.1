...
#ifndef PROJECT_ZB2_ZCLASS_HEAL_H
#define PROJECT_ZB2_ZCLASS_HEAL_H

#include "zb2_zclass.h"

class CZombieClass_Heal : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Heal(CBasePlayer *player, ZombieLevel lv);
