...
#ifndef PROJECT_ZB2_ZCLASS_GANIMED_H
#define PROJECT_ZB2_ZCLASS_GANIMED_H

#include "zb2_zclass.h"

class CZombieClass_Ganimed : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Ganimed(CBasePlayer *player, ZombieLevel lv);
