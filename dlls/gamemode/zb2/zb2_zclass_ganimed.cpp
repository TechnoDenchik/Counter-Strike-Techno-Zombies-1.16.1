...
void CZombieClass_Ganimed::Precache()
{
...
CZombieClass_Ganimed::CZombieClass_Ganimed(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_Ganimed::InitHUD() const
{
...
void CZombieClass_Ganimed::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_Ganimed::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_Ganimed::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_Ganimed::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_Ganimed::DeathSound_Zombie()
{
...
void CZombieClass_Ganimed::OnThink()
{
	Zombie_HealthRecoveryThink();
	return CZombieClass_Ganimed::OnThink();
}

void CZombieClass_Ganimed::Zombie_HealthRecoveryThink()
{
