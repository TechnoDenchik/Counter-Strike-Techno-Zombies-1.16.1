...
void CZombieClass_Psycho::Precache()
{
...
CZombieClass_Psycho::CZombieClass_Psycho(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_Psycho::InitHUD() const
{
...
void CZombieClass_Psycho::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_Psycho::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_Psycho::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_Psycho::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_Psycho::DeathSound_Zombie()
{
...
void CZombieClass_Psycho::OnThink()
{
	Zombie_HealthRecoveryThink();
	return CZombieClass_Psycho::OnThink();
}

void CZombieClass_Psycho::Zombie_HealthRecoveryThink()
{
