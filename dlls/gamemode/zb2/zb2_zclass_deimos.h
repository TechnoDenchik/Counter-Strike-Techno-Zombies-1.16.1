...
#ifndef PROJECT_ZB2_ZCLASS_DEIMOS_H
#define PROJECT_ZB2_ZCLASS_DEIMOS_H

#include "zb2_zclass.h"

class CZombieClass_Deimos : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Deimos(CBasePlayer *player, ZombieLevel lv);
