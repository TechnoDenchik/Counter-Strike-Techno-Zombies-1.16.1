...
{
public:
	explicit CHeroSkill(CBasePlayer* player);
...
class CHeroSkill_Empty : public BasePlayerExtra, public IZombieSkill
{
public:
	explicit CHeroSkill_Empty(CBasePlayer* player) : BasePlayerExtra(player) {}
...
class CHeroSkill_sprint : public CHeroSkill
{
public:
	explicit CHeroSkill_sprint(CBasePlayer* player);
