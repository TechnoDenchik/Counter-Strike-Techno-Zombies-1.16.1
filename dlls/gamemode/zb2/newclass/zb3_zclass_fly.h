...
#ifndef PROJECT_ZB3_ZCLASS_FLY_H
#define PROJECT_ZB3_ZCLASS_FLY_H

#include "../zb2_zclass.h"

class CZombieClass_Fly : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Fly(CBasePlayer *player, ZombieLevel lv);
