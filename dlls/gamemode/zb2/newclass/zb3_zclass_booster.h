...
#ifndef PROJECT_ZB3_ZCLASS_BOOSTER_H
#define PROJECT_ZB3_ZCLASS_BOOSTER_H

#include "../zb2_zclass.h"

class CZombieClass_Booster : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Booster(CBasePlayer *player, ZombieLevel lv);
