...
#include "zb3_zclass_fly.h"

void CZombieClass_Fly::Precache()
{
...
CZombieClass_Fly::CZombieClass_Fly(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_Fly::InitHUD() const
{
...
void CZombieClass_Fly::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_Fly::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_Fly::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_Fly::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_Fly::DeathSound_Zombie()
{
...
void CZombieClass_Fly::OnThink()
{
	Zombie_HealthRecoveryThink();
	return CZombieClass_Fly::OnThink();
}

void CZombieClass_Fly::Zombie_HealthRecoveryThink()
{
