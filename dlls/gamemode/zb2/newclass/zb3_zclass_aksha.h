...
#ifndef PROJECT_ZB3_ZCLASS_AKSHA_H
#define PROJECT_ZB3_ZCLASS_AKSHA_H

#include "../zb2_zclass.h"

class CZombieClass_Aksha : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Aksha(CBasePlayer *player, ZombieLevel lv);
