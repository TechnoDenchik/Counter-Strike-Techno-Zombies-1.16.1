...
#ifndef PROJECT_ZB3_ZCLASS_BOOMER_H
#define PROJECT_ZB3_ZCLASS_BOOMER_H

#include "../zb2_zclass.h"

class CZombieClass_Boomer : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Boomer(CBasePlayer *player, ZombieLevel lv);
