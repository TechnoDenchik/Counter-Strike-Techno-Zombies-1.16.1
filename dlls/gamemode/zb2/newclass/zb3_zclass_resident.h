...
#ifndef PROJECT_ZB3_ZCLASS_RESIDENT_H
#define PROJECT_ZB3_ZCLASS_RESIDENT_H

#include "../zb2_zclass.h"

class CZombieClass_Resident : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Resident(CBasePlayer *player, ZombieLevel lv);
