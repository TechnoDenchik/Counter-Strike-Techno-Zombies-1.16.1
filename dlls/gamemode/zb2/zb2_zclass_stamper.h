...
#ifndef PROJECT_ZB2_ZCLASS_STAMPER_H
#define PROJECT_ZB2_ZCLASS_STAMPER_H

#include "zb2_zclass.h"

class CZombieClass_Stamper : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Stamper(CBasePlayer *player, ZombieLevel lv);
