...
#ifndef PROJECT_ZB2_ZCLASS_BANCHEE_H
#define PROJECT_ZB2_ZCLASS_BANCHEE_H

#include "zb2_zclass.h"

class CZombieClass_Banchee : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Banchee(CBasePlayer *player, ZombieLevel lv);
