...
#ifndef PROJECT_ZB2_ZCLASS_HEAVY_H
#define PROJECT_ZB2_ZCLASS_HEAVY_H

#include "zb2_zclass.h"

class CZombieClass_Heavy : public CBaseZombieClass_ZB2
{
public:
	explicit CZombieClass_Heavy(CBasePlayer *player, ZombieLevel lv);
