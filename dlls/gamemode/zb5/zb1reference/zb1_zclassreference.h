...
#ifndef PROJECT_ZB1R_ZCLASS_H
#define PROJECT_ZB1R_ZCLASS_H

#include "player/player_mod_strategy.h"

class IZombieModeCharacterR
{
public:
	virtual ~IZombieModeCharacterR() = default;
...
class CHuman_ZB1R : public BasePlayerExtra, public IZombieModeCharacterR
{
public:
	explicit CHuman_ZB1R(CBasePlayer *player); // player_zombie.cpp
	void Think() override {}
...
class CZombie_ZB1R : public BasePlayerExtra, public IZombieModeCharacterR
{
public:
	explicit CZombie_ZB1R(CBasePlayer *player, ZombieLevel lv); // player_zombie.cpp
	void Think() override {}
