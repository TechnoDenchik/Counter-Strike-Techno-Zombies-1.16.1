...
#ifndef PROJECT_ZB2_ZCLASS_SPIDER_H
#define PROJECT_ZB2_ZCLASS_SPIDER_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

#include "gamemode/zb5/mod_zb1reference.h"

class CZombieClass_Spider : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_Spider(CBasePlayer *player, ZombieLevel lv);
