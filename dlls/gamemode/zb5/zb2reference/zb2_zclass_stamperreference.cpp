...
void CZombieClass_StamperR::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
	...
	{
		case 0: EMIT_SOUND(ENT(m_pPlayer->pev), CHAN_AUTO, "zb3/zombi_hurt_stamper_1.wav", VOL_NORM, ATTN_NORM); break;
		case 1: EMIT_SOUND(ENT(m_pPlayer->pev), CHAN_AUTO, "zb3/zombi_hurt_stamper_2.wav", VOL_NORM, ATTN_NORM); break;
		default:break;
	}
}
...
void CZombieClass_StamperR::DeathSound_Zombie()
{
	...
	{
		case 1: EMIT_SOUND(ENT(m_pPlayer->pev), CHAN_AUTO, "zb3/zombi_death_stamper_1.wav", VOL_NORM, ATTN_NORM); break;
		case 2: EMIT_SOUND(ENT(m_pPlayer->pev), CHAN_AUTO, "zb3/zombi_death_stamper_2.wav", VOL_NORM, ATTN_NORM); break;
		default:break;
	}
}
