...
#include "gamemode/zb5/zb2reference/zb2_zclass_bancheereference.h"

void CZombieClass_BancheeR::Precache()
{
	PRECACHE_SOUND("sound/zb3/zombi_hurt_banshee_1.wav");
	PRECACHE_SOUND("sound/zb3/zombi_death_banshee_1.wav");
}

CZombieClass_BancheeR::CZombieClass_BancheeR(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2R(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_BancheeR::InitHUD() const
{
...
void CZombieClass_BancheeR::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_BancheeR::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2R::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_BancheeR::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_BancheeR::OnThink()
{
	...
	return CZombieClass_BancheeR::OnThink();
}

void CZombieClass_BancheeR::Zombie_HealthRecoveryThink()
{
