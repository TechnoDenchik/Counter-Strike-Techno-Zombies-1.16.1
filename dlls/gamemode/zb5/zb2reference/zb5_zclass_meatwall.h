...
#ifndef PROJECT_ZB2_ZCLASS_MEATWALL_H
#define PROJECT_ZB2_ZCLASS_MEATWALL_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

#include "gamemode/zb5/mod_zb1reference.h"

class CZombieClass_MeatWall : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_MeatWall(CBasePlayer *player, ZombieLevel lv);
