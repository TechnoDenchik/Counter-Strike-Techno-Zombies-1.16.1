...
#ifndef PROJECT_ZB2_ZCLASS_BANCHEER_H
#define PROJECT_ZB2_ZCLASS_BANCHEER_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_BancheeR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_BancheeR(CBasePlayer *player, ZombieLevel lv);
