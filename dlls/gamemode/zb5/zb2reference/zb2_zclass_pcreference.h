...
#ifndef PROJECT_ZB2_ZCLASS_PSYCHOR_H
#define PROJECT_ZB2_ZCLASS_PSYCHOR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_PsychoR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_PsychoR(CBasePlayer *player, ZombieLevel lv);
