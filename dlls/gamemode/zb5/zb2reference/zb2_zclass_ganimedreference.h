...
#ifndef PROJECT_ZB2_ZCLASS_GANIMEDR_H
#define PROJECT_ZB2_ZCLASS_GANIMEDR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_GanimedR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_GanimedR(CBasePlayer *player, ZombieLevel lv);
