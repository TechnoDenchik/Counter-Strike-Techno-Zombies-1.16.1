...
#ifndef PROJECT_ZB2_ZCLASS_HEALR_H
#define PROJECT_ZB2_ZCLASS_HEALR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_HealR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_HealR(CBasePlayer *player, ZombieLevel lv);
