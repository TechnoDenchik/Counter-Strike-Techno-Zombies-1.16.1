...
#ifndef PROJECT_ZB2_ZCLASS_DEIMOSR_H
#define PROJECT_ZB2_ZCLASS_DEIMOSR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_DeimosR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_DeimosR(CBasePlayer *player, ZombieLevel lv);
