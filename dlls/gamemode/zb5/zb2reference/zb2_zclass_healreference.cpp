...
void CZombieClass_HealR::Precache()
{
...
CZombieClass_HealR::CZombieClass_HealR(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2R(player, iEvolutionLevel)
{
	Precache();
...
void CZombieClass_HealR::InitHUD() const
{
...
void CZombieClass_HealR::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 310;
}

float CZombieClass_HealR::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2R::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_HealR::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
...
void CZombieClass_HealR::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_HealR::DeathSound_Zombie()
{
...
void CZombieClass_HealR::OnThink()
{
	Zombie_HealthRecoveryThink();
	return CZombieClass_HealR::OnThink();
}

void CZombieClass_HealR::Zombie_HealthRecoveryThink()
{
