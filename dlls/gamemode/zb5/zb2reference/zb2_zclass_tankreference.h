...
#ifndef PROJECT_ZB2_ZCLASS_TANKR_H
#define PROJECT_ZB2_ZCLASS_TANKR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

#include "gamemode/zb5/mod_zb1reference.h"

class CZombieClass_DefaultR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_DefaultR(CBasePlayer *player, ZombieLevel lv);
