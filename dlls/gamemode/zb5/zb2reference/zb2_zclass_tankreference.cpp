...
void CZombieClass_DefaultR::Precache()
{
...
CZombieClass_DefaultR::CZombieClass_DefaultR(CBasePlayer *player, ZombieLevel iEvolutionLevel) : CBaseZombieClass_ZB2R(player, iEvolutionLevel)
{
...
void CZombieClass_DefaultR::InitHUD() const
{
...
void CZombieClass_DefaultR::ResetMaxSpeed() const
{
	m_pPlayer->pev->maxspeed = 390;
}

float CZombieClass_DefaultR::AdjustDamageTaken(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType) const
{
	flDamage *= 0.9;
	return CBaseZombieClass_ZB2R::AdjustDamageTaken(pevInflictor, pevAttacker, flDamage, bitsDamageType);
}

bool CZombieClass_DefaultR::ApplyKnockback(CBasePlayer *attacker, const KnockbackData &kbd)
{
	// knife knockback
...
void CZombieClass_DefaultR::Pain_Zombie(int m_LastHitGroup, bool HasArmour)
{
...
void CZombieClass_DefaultR::DeathSound_Zombie()
{
