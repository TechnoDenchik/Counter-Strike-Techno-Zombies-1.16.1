...
#ifndef PROJECT_ZB3_ZCLASS_BOOMERR_H
#define PROJECT_ZB3_ZCLASS_BOOMERR_H

#include "../zb2_zclassreference.h"

class CZombieClass_BoomerR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_BoomerR(CBasePlayer *player, ZombieLevel lv);
