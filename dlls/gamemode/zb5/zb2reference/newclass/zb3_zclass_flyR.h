...
#ifndef PROJECT_ZB3_ZCLASS_FLYR_H
#define PROJECT_ZB3_ZCLASS_FLYR_H

#include "../zb2_zclassreference.h"

class CZombieClass_FlyR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_FlyR(CBasePlayer *player, ZombieLevel lv);
