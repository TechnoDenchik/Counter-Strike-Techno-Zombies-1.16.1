...
#ifndef PROJECT_ZB3_ZCLASS_RESIDENTR_H
#define PROJECT_ZB3_ZCLASS_RESIDENTR_H

#include "../zb2_zclassreference.h"

class CZombieClass_ResidentR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_ResidentR(CBasePlayer *player, ZombieLevel lv);
