...
#ifndef PROJECT_ZB2_ZCLASS_HEAVYR_H
#define PROJECT_ZB2_ZCLASS_HEAVYR_H

#include "gamemode/zb5/zb2reference/zb2_zclassreference.h"

class CZombieClass_HeavyR : public CBaseZombieClass_ZB2R
{
public:
	explicit CZombieClass_HeavyR(CBasePlayer *player, ZombieLevel lv);
