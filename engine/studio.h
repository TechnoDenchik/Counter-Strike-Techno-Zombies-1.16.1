...
#define MAXSTUDIOBODYPARTS		64	// body parts per submodel
#define MAXSTUDIOGROUPS		16	// sequence groups (e.g. barney01.mdl, barney02.mdl, e.t.c)
#define MAXSTUDIOANIMATIONS		1024	// max frames per sequence
#define MAXSTUDIOMESHES		1024	// max textures per model
#define MAXSTUDIOEVENTS		4096	// events per model
#define MAXSTUDIOPIVOTS		256	// pivot points
#define MAXSTUDIOBLENDS		128	// max anim blends
#define MAXSTUDIOCONTROLLERS		8	// max controllers per model
#define MAXSTUDIOATTACHMENTS		1024	// max attachments per model
