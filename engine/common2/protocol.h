...
#define MAX_CUSTOM			4096	// max custom resources per level
#define MAX_USER_MESSAGES		191	// another 63 messages reserved for engine routines
#define MAX_DLIGHTS			512	// dynamic lights (rendered per one frame)
#define MAX_ELIGHTS			512	// entity only point lights
