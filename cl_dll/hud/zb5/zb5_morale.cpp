...
CHudZB5Morale::CHudZB5Morale(void){}

int CHudZB5Morale::VidInit(void)
{
...
int CHudZB5Morale::Draw(float time)
{
	...
	int iMaxMorale = 10;
	if (m_iMoraleType == ZB5_MORALE_STRENGTHEN)
	{
		iMorale += 3;
		iMaxMorale += 3;
	}
...
void CHudZB5Morale::UpdateLevel(ZB5HumanMoraleType_e type, int level)
{
