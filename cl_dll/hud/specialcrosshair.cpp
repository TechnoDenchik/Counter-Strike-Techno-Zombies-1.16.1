...
{
	m_iFlags |= HUD_DRAW;
	R_InitTexture(m_pCurTexture[0], "weaponres/dgaxe_aim_off.tga");
	R_InitTexture(m_pCurTexture[1], "weaponres/dgaxe_aim_on.tga");
	R_InitTexture(m_pCurTexture[2], "weaponres/dgaxe_aim_on_2.tga");
	R_InitTexture(m_pCurTexture[3], "weaponres/huntbow_aim_default1.tga");	//center
	R_InitTexture(m_pCurTexture[4], "weaponres/huntbow_aim_default2.tga");	//left
	R_InitTexture(m_pCurTexture[5], "weaponres/huntbow_aim_default3.tga");	//right
	R_InitTexture(m_pCurTexture[6], "weaponres/huntbow_aim_charging.tga");
	R_InitTexture(m_pCurTexture[7], "weaponres/skullt9_aim_off.tga");
	R_InitTexture(m_pCurTexture[8], "weaponres/skullt9_aim_on.tga");
	R_InitTexture(m_pCurTexture[9], "weaponres/whipsword_aim_off.tga");
	R_InitTexture(m_pCurTexture[10], "weaponres/whipsword_aim_on.tga");
	R_InitTexture(m_pCurTexture[11], "weaponres/y22s2sfsword_aim_on.tga");
	...
	R_InitTexture(m_pCurTexture[14], "weaponres/divinetitan_aim_on.tga");
	//R_InitTexture(m_pCurTexture[15], "weaponres/ef_divinetitan_bmode.tga");
	return 1;
}
