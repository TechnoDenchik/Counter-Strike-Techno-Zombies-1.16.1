...
{
	 "weapons/broad-1.wav", "weapons/broad-2.wav"
};

void EV_FireBROAD(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(BROAD_SHOOT1, BROAD_SHOOT2), 2);
		EV_MuzzleFlash();
