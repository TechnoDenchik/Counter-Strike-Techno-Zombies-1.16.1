...
static const char* SOUNDS_NAME = "weapons/pkm.wav";

void EV_FirePKM(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(PKM_SHOOT1, PKM_SHOOT2), 2);
		EV_MuzzleFlash();
