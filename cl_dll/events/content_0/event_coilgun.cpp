...
void EV_FireBLASTER(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(BLASTER_SHOOT1, BLASTER_SHOOT3), 2);
		EV_MuzzleFlash();
	...
	PLAY_EVENT_SOUND( "weapons/blaster_fire1.wav" );
