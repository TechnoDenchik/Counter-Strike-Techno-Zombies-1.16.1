...
void EV_FireM60E4(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(M60E4_SHOOT1, M60E4_SHOOT2), 2);
		EV_MuzzleFlash();
	...
	PLAY_EVENT_SOUND( "weapons/m60e4.wav" );
