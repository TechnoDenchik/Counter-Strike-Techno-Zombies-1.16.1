...
{
	 "weapons/balrog7-1.wav", "weapons/balrog7-exp.wav"
};

void EV_FireBalrog7(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(BALROG7_SHOOT1, BALROG7_SHOOT3), 2);
