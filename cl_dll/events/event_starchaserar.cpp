...
static const char *SOUNDS_NAME = "weapons/starchaserar-1.wav";

void EV_FireStarchaserar( struct event_args_s *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(STARCHASERAR_SHOOT1, STARCHASERAR_SHOOT3), 2);
