...
void EV_FireStg44( event_args_t *args )
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(STG44_SHOOT1, STG44_SHOOT3), 2);
		EV_MuzzleFlash();
	...
	PLAY_EVENT_SOUND("weapons/stg44_1.wav");
