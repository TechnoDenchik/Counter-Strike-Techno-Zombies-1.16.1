...
int CHudZSHScoreboard::Draw(float time)
{
	...
	int y10 = ScreenHeight / 1.030; // Движение по горизонтали
	...
	//DrawUtils::DrawHudString2(x8 + 20, y8 + 5, ScreenWidth, "Day", r, g, b, flScale);
	...
	//DrawUtils::DrawHudString2(x13 - 80, y10, ScreenWidth, szBuffer2, r2, g2, b2, flScale);
	DrawTexturedNumbersTopRightAligned(*countplayer2, m_rcToprecord2, maxwoods2, x13 - 30, y10, 1.0f);

	sprintf(szBuffer3, "%d", maxmetal);
	//DrawUtils::DrawHudString2(x14 + 20, y10, ScreenWidth, szBuffer3, r2, g2, b2, flScale);
	DrawTexturedNumbersTopRightAligned(*countplayer2, m_rcToprecord2, maxmetal2, x14 + 78, y10, 1.0f);

	sprintf(szBuffer4, "%d", woods);
	//DrawUtils::DrawHudString2(x15 + 20, y10, ScreenWidth, szBuffer4, r2, g2, b2, flScale);
	DrawTexturedNumbersTopRightAligned(*countplayer2, m_rcToprecord2, woods2, x13 - 60, y10, 1.0f);

	sprintf(szBuffer5, "%d", metal);
	//DrawUtils::DrawHudString2(x16 + 20, y10, ScreenWidth, szBuffer5, r2, g2, b2, flScale);
	DrawTexturedNumbersTopRightAligned(*countplayer2, m_rcToprecord2, metal2, x14 + 20, y10, 1.0f);
